...
## Purpose
TBD - created by archiving change rename-opsx-openspec-to-dwsp-duowenspec. Update Purpose after archive.
## Requirements
...
Core operation user-facing guidance SHALL use `duowenspec` naming instead of `openspec` where product keyword is presented.
