...
- Rename visible `openspec` product keyword references to `duowenspec` in core operation flows and user-facing output.
...
- user-facing core setup/update guidance still exposes `openspec` keyword where `duowenspec` is required
