...
- [x] 1.2 Validate the change artifacts with `openspec validate enhance-init-localized-modo-scaffold`
...
- [x] 3.1 Add `--scaffold` to `openspec init` and route scaffold generation through a dedicated helper
...
- [x] 4.1 Update `openspec update` so localized generated skill/command assets refresh consistently
...
- [x] 5.4 Run a real `openspec init --scaffold` command in a temporary project and inspect the generated result
