...
- 先调用 \`dwsp-b-end-delivery\`，把当前 DuowenSpec 产物转成统一的页面模式与模板选择
...
- 开始实现前先调用 \`dwsp-b-end-delivery\`，确认 pattern、模板和关键组件
- 具体组件解析时调用 \`dwsp-b-end-components\`，严格以 \`duowenspec/b-end/MANIFEST.md\` 为准
- 输出前必须调用 \`dwsp-b-end-review\`，确保布局、组件和交互规则保持统一
