...
- **AND** the command ID, file path convention, and `/dwsp:*` workflow names SHALL remain unchanged
...
- **WHEN** user runs `duowenspec init <path> --scaffold`
- **THEN** create the standard `duowenspec/` directory structure
