...
- [x] 3.1 Replace user-facing core operation `duowenspec` references with `duowenspec` in init/update messaging
- [x] 3.2 Update docs/instruction templates in active command surfaces to use `duowenspec`
- [x] 3.3 Verify no mixed `opsx`/`duowenspec` keywords remain in core generated assets
...
- [x] 4.4 Validate change artifacts with `node bin/opsx.js validate rename-opsx-duowenspec-to-dwsp-duowenspec`
